      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/pdf-detection" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-300 hover:text-white'
                    : 'text-blue-200 hover:text-white'
                }`}>PDF Language Detection</a>
              </li>
              <li>
                <a href="/text-detection" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-300 hover:text-white'
                    : 'text-blue-200 hover:text-white'
        ...
        <div className={`mt-12 pt-8 border-t ${isDarkMode ? 'border-gray-700' : 'border-blue-800'}`}>
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <a href="/cookies" className={`transition-colors duration-300 ${
                isDarkMode 
                  ? 'text-gray-300 hover:text-white'
                  : 'text-blue-200 hover:text-white'
              }`}>Cookie Policy</a>
